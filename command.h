...
/* Hace una compia de self
*/

char** scommand_to_array(scommand command);
/*
* Dado `command` crea un array de *char cuyo primer elemento
* es el comando y los siguientes elementos son los argumentos del mismo.
* Es decir, devuelve algo de la forma:
*    [cmd, arg1, arg2, ... , argn]
* donde cada elemento del array es un *char
*/
...
/* Devuelve el n-ésimo comando de self
